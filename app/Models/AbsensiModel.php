...
class AbsensiModel extends Model {
  ...
  public function getAllAbsensi() {
    ...
    $builder->select('absensi.id as id, absensi.tanggal as tanggal, siswa.nis as nis, semester.semester as semester, siswa.nama as nama, siswa.id_kelas as kelas, absensi.absen as absen, absensi.keterangan as keterangan');
